    ...
    <div class="col-lg-12">
        <div class="card card-custom gutter-b">
            ...
            <div class="card-body">
                ...
                <div class="row">
                    <div class="col-md-8">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-4">
                                <label>Paired Quantity Packaging QR:</label>
                                <input disabled type="text" class="form-control" value="<?php echo $data_sub_batch["SUBPA_PAIRED_QTY"]; ?>">
                            </div>
                            <div class="col-lg-4">
                ...
                <div class="form-group row">
                    <div class="col-lg-12">
                        <label>Batch Packaging Discrepancy Notes:</label>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-lg-6">
                        ...
                        <textarea disabled rows="5" class="form-control"><?php echo $pool_product["POPRD_MPRVE_NOTES"]; ?></textarea>
                    </div>
                </div>
                <div id="qr_list">
                    <div class="form-group row">
