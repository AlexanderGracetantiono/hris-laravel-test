...
<html lang="en">
	<head>
		<base href="">
		<meta charset="utf-8" />
		<title>CekOri | @yield('page_title')</title>
	...
	<body id="kt_body" class="header-fixed header-mobile-fixed page-loading">
		<div id="kt_header_mobile" class="header-mobile bg-primary header-mobile-fixed">
			<a href="{{ route('home')}}">
				<img alt="Logo" src="{{ asset('app-logo.png') }}" class="max-h-30px" />
			</a>
		...
		<script src="{{ asset('custom/js/global/remove_space.js') }}"></script>
		<script src="{{ asset('custom/js/global/sweet_alert_submit.js') }}"></script>
		<script src="{{ asset('custom/js/global/sweet_alert_delete.js') }}"></script>
        @stack('scripts')
	</body>
</html>