...
<body>
    ...
    ?>
    <?php for ($i = 0; $i < count($qrcode); $i++) { ?> <?php if
        ($counter % ($row_count * $col_count)==0) { ?> 
        <div style="background-color: coral;height: 4mm;">
        ...
        <table style="background-color: blueviolet;padding-left: {{$margin_left_right}}mm;padding-right: {{$margin_left_right}}mm;">
        <?php } ?>
        <?php if ($counter % $row_count == 0) { ?>
        <tr>
            <?php } ?>
            <td class="qr"
            style="background-color: cadetblue;width: {{$border_size}}mm;height:{{$qr_height}}mm">
                <div class="row">
            ...
            <td style="background-color: crimson;width:4mm;">
            </td>
            <?php } ?>
        ...
        <?php if ($counter % ($row_count * $col_count) != 0) { ?>
            <tr>
                <td style="background-color: aqua; height: {{$qr_vertical_margin}}mm;">
                </td>
            </tr>
        ...
        <div style="background-color: crimson;height: {{$header_footer_height}}mm;">
        </div>
        <?php $page_counter+=1; }  ?>
        <?php } ?>
