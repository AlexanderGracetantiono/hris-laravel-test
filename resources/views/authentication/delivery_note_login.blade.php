...
<head>
	<meta charset="utf-8" />
	<title>CekOri | Halaman Login</title>
		...
		<div class="login login-1 login-7 login-signin-on d-flex flex-column flex-lg-row flex-column-fluid bg-white" id="kt_login">
			<div class="login-aside d-flex flex-column flex-row-auto" style="background-color: #F2C98A;">
				<div class="d-flex flex-column-auto flex-column pt-lg-40 pt-15">
					...
					<h3 class="font-weight-bolder text-center font-size-h4 font-size-h1-lg" style="color: #986923;">CekOri
			...
			<div class="login-content flex-row-fluid d-flex flex-column justify-content-center position-relative overflow-hidden p-7 mx-auto">
				<div class="d-flex flex-column-fluid flex-center">
					<div class="login-form login-signin">
						<form action="{{ route('login_delivery_note') }}" method="POST" class="form" novalidate="novalidate" id="kt_login_signin_form" data-form-success-redirect="{{ route('detail_delivery_note', ['id' => $data]) }}">
							@csrf
