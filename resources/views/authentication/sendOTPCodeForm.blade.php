...
<head>
    <meta charset="utf-8" />
    <title>CekOri | Login Authentication</title>
...
<body id="kt_body" class="header-fixed header-mobile-fixed subheader-enabled page-loading">
            ...
            <div class="d-flex flex-center flex-row-fluid bgi-size-cover bgi-position-top bgi-no-repeat"
                ...
                <div class="login-form text-center p-7 position-relative overflow-hidden">
                    ...
                    <div class="login-signin">
                        <div class="mb-20">
                            <h3>CekOri</h3>
                            <div class="text-muted font-weight-bold">Input Verification Code :</div>
                        </div>
                        <div>
                            <form action="{{ route('sent_otp_code') }}" method="POST" class="form"
                                novalidate="novalidate" id="kt_sent_otp_form"
                                data-form-success-redirect="{{ route('home') }}">
                                @csrf
                                <div class="form-group">
                                    <input
                                        class="form-control form-control-solid h-auto py-7 px-6 rounded-lg font-size-h6"
                                        type="text" placeholder="Verification code" name="otp_code"
                                        autocomplete="off" />
                                </div>
                                <div class="d-flex justify-content-between mt-20">
                                    <a href="{{ route('login_view') }}"
                                        class="btn btn-light-primary font-weight-bolder font-size-h6 px-8 py-4 my-3">Back</a>
                                    <button type="submit"
                                        class="btn btn-primary font-weight-bolder font-size-h6 px-8 py-4 my-3 mr-4">Submit</button>
                                </div>
                            </form>
                            <form style="position: absolute;bottom: 12%;width: 88%"
                                action="{{ route('resend_verification_code') }}" method="POST" class="form"
                                novalidate="novalidate" id="kt_resent_otp_form"
                                data-form-success-redirect="{{ route('view_otp_form') }}">
                                @csrf
                                <div class="form-group mt-10" style="width: 100%">
                                    ...
                                    <button type="submit" id="btn_countdown"
									style="width: 100%"
                                        class="btn btn-primary font-weight-bolder font-size-h6 px-8 py-4 my-3 mr-4">
                                        Resend Verification Code
                                    </button>
    ...
    <script src="{{ asset('custom/js/authentication/login/sentOTPCode.js') }}"></script>
</body>
<!--end::Body-->
