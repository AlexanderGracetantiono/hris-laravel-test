...
<html lang="en">
	...
	<head>
		<meta charset="utf-8" />
		<title>CekOri | Forgot Password</title>
			...
			<div class="login login-4 login-signin-on d-flex flex-row-fluid bg-white" id="kt_login">
				<div class="d-flex flex-center flex-row-fluid bgi-size-cover bgi-position-top bgi-no-repeat" style="background-image: {{ url('assets/media/bg/bg-3.jpg') }}">
					<div class="login-form text-center p-7 position-relative overflow-hidden">
						<!--begin::Login Header-->
						<div class="d-flex flex-center mb-15 btn-primary div-header" >
							<a href="#">
						...
						<div class="login-signin">
							<div class="mb-20">
								<h3>CekOri</h3>
								<div class="text-muted font-weight-bold">Input Your New Password:</div>
							</div>
							<form action="{{ route("forgot_password_save") }}" method="POST" class="form" novalidate="novalidate" id="forgot_password_save" data-form-success-redirect="{{ route("login_view") }}">
								@csrf
								<input type="hidden" value="{{ $MAEMP_CODE }}" name="MAEMP_CODE">
								<div class="form-group">
									<input class="form-control form-control-solid h-auto py-7 px-6 rounded-lg font-size-h6" type="password" placeholder="New Password" name="password_new" autocomplete="off" />
								</div>
								<div class="form-group">
									<input class="form-control form-control-solid h-auto py-7 px-6 rounded-lg font-size-h6" type="password" placeholder="New Password Confirmation" name="password_new_confirmation" autocomplete="off" />
								</div>
