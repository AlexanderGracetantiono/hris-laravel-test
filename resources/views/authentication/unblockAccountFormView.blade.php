...
<head>
	<meta charset="utf-8" />
	<title>CekOri | Unblock Account</title>
...
<body id="kt_body" class="header-fixed header-mobile-fixed subheader-enabled page-loading">
			...
			<div class="d-flex flex-center flex-row-fluid bgi-size-cover bgi-position-top bgi-no-repeat" style="background-image: {{ url('assets/media/bg/bg-3.jpg') }}">
				<div class="login-form text-center p-7 position-relative overflow-hidden">
					...
					<div class="login-signin">
						<div class="mb-20">
							<h3>CekOri</h3>
							<div class="text-muted font-weight-bold">Input Your Email for Unblock Account :</div>
						</div>
						<form action="{{ route("unblock_account_send_mail") }}" method="POST" class="form" novalidate="novalidate" id="kt_login_unblock_form" data-form-success-redirect="{{ route("login_view") }}">
							@csrf
							<div class="form-group">
								<input class="form-control form-control-solid h-auto py-7 px-6 rounded-lg font-size-h6" type="email" placeholder="Email" name="account_name_email" autocomplete="off" />
							</div>
							<div class="d-flex justify-content-between mt-n5">
								<a href="/" class="btn btn-light-primary font-weight-bolder font-size-h6 px-8 py-4 my-3">Back</a>
	...
	<script src="{{ asset('custom/js/authentication/login/unblockAccount.js') }}"></script>
</body>
<!--end::Body-->
