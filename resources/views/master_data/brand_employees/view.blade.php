...
<div class="card card-custom">
    <div class="card-header py-3">
        <div class="card-title">
            <h3 class="card-label">Master Data User, Brand : <?php echo $brand["MBRAN_NAME"] ?></h3>
        </div>
        <div class="card-toolbar">
            <a href="{{ route('master_data_employee_brand_add', ['brand_code' => $brand['MBRAN_CODE']]) }}" class="btn btn-primary font-weight-bolder">
        ...
        <table class="table table-bordered table-checkable" id="kt_datatable1">
            ...
            <tbody>
                ...
                <tr <?php if ($employee['MAEMP_STATUS'] != 1) { echo ("style='background-color:#eeeeee'");} ?>>
                    ...
                    <td nowrap="nowrap">
                        @if ($employee["MAEMP_ROLE"] == "PIC Brand")
                            <a href="{{ route('master_data_employee_brand_edit', ['maemp_id' => $employee['MAEMP_ID'],'brand_code' => $brand['MBRAN_CODE']]) }}" class="btn btn-sm btn-clean btn-icon"   title="Edit Employee"> <i class="la la-edit"></i>
                            </a>
