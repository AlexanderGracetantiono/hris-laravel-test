    ...
    <div class="col-lg-12">
        <div class="card card-custom gutter-b">
            <div class="card-header">
                <h3 class="card-title">Detail Sub Batch Packaging</h3>
            </div>
            <form class="form" id="form" method="POST" data-form-success-redirect="{{ route('master_data_sub_batch_packaging_view') }}">
                @csrf
                ...
                <div class="card-body">
                    ...
                    <div class="form-group row">
                        <div class="col-md-12">
                            <br><h4>3. Sub Batch Packaging Data</h4>
                        </div>
                    </div>
                    <div class="form-group row">
                        <div class="col-lg-4">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-lg-3">
                            <label>Paired Packaging QR:</label>
                    ...
                    <div class="form-group row">
                        <div class="col-md-12">
                            <br><h4>4. Assigned User Packaging</h4>
                        </div>
                    </div>
                ...
                <div class="card-footer">
                    <a href="{{ route('master_data_sub_batch_packaging_view') }}" class="btn btn-secondary float-left">Back</a>
                    @if($data["SUBPA_ACTIVATION_STATUS"] == 0)
                        <button type="button" data-action="{{ route('master_data_sub_batch_packaging_activate') }}" class="btn btn-primary float-right mr-2 activation_btn"> <i class="la la-check"></i>Activate batch</button>
                    @elseif($data["SUBPA_ACTIVATION_STATUS"] == 1)
                        <button type="button" data-action="{{ route('master_data_sub_batch_packaging_close') }}" class="btn btn-primary float-right mr-2 close_btn"> <i class="la la-times"></i>Close batch</button>
                    @endif
                    <br><br>
                </div>
            </form>
