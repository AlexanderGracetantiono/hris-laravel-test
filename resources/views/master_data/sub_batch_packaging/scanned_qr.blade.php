...
@push('scripts')
<script src="{{ asset('custom/js/master_data/sub_batch_packaging/reject_qr.js') }}"></script>
...
<script src="{{ asset('custom/js/master_data/sub_batch_packaging/report.js') }}"></script>
@endpush
    ...
    <div class="col-lg-12">
        <div class="card card-custom gutter-b">
            <div class="card-header">
                <h3 class="card-title">Close Batch Packaging</h3>
                <div class="card-toolbar">
                    <button type="button" data-action="{{ route('master_data_sub_batch_packaging_close') }}" class="btn btn-success btn-pill float-right mr-2 close_btn"> <i class="la la-times"></i>Close batch</button>
                </div>
            </div>
            <div class="card-body">
                <form class="form" id="form_close" method="POST" data-form-success-redirect="{{ route('master_data_sub_batch_packaging_view') }}">
                    @csrf
        ...
        <div class="card card-custom gutter-b">
            <div class="card-header">
                <h3 class="card-title">Detail Batch Packaging</h3>
            </div>
            <div class="card-body">
                <div class="form-group row">
                    <div class="col-md-12">
