...
<script src="{{ asset('custom/js/master_data/sub_batch_packaging/repeater.js') }}"></script>
<script src="{{ asset('custom/js/master_data/sub_batch_packaging/submit_ajax.js') }}"></script>
<script src="{{ asset('custom/js/master_data/sub_batch_packaging/get_staff_packaging.js') }}"></script>
@endpush
    ...
    <div class="col-lg-12">
        <div class="card card-custom gutter-b">
            <div class="card-header">
                <h3 class="card-title">Create Batch Packaging Form</h3>
            </div>
            <form class="form" id="form" method="POST" action="{{ route('master_data_sub_batch_packaging_save') }}" data-form-success-redirect="{{ route('master_data_sub_batch_packaging_view') }}" enctype="multipart/form-data">
                @csrf
                <div class="card-body">
                    ...
                    <div class="form-group row">
                        <div class="col-md-12">
                            <br><h4>4. Assign User Packaging</h4>
                        </div>
                    </div>
                    <div class="form-group row">
