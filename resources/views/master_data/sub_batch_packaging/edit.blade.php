...
@push('scripts')
<script src="{{ asset('custom/js/master_data/sub_batch_packaging/date.js') }}"></script>
<script src="{{ asset('custom/js/master_data/sub_batch_packaging/select2.js') }}"></script>
<script src="{{ asset('custom/js/master_data/sub_batch_packaging/delete_ajax.js') }}"></script>
<script src="{{ asset('custom/js/master_data/sub_batch_packaging/repeater_edit.js') }}"></script>
<script src="{{ asset('custom/js/master_data/sub_batch_packaging/submit_ajax.js') }}"></script>
    ...
    <div class="col-lg-12">
        <div class="card card-custom gutter-b">
            <div class="card-header">
                <h3 class="card-title">Activate Batch Packaging Form</h3>
                <div class="card-toolbar">
                    <button type="button" data-action="{{ route('master_data_sub_batch_packaging_activate') }}" class="btn btn-success btn-pill float-right mr-2 activation_btn"> <i class="la la-check"></i>Activate batch</button>
                </div>
            </div>
            <form class="form" id="form_activate" method="POST" data-form-success-redirect="{{ route('master_data_sub_batch_packaging_view') }}">
                @csrf
        ...
        <div class="card card-custom gutter-b">
            <div class="card-header">
                <h3 class="card-title">Edit Batch Packaging Form</h3>
            </div>
            <form class="form" id="form" method="POST" action="{{ route("master_data_sub_batch_packaging_update") }}" data-form-success-redirect="{{ route("master_data_sub_batch_packaging_view") }}" enctype="multipart/form-data">
                @csrf
                <input type="hidden" name="SUBPA_CODE" value="<?php echo $data["SUBPA_CODE"]; ?>">
                ...
                <div class="card-body">
                    ...
                    <div class="form-group row">
                        <div class="col-md-12">
                            <br><h4>3. Batch Packaging Data</h4>
                        </div>
                    </div>
                    <div class="form-group row">
                        <div class="col-lg-4">
                    ...
                    <div class="form-group row">
                        <div class="col-md-12">
                            <br><h4>4. Assign Staff Packaging</h4>
                        </div>
                    </div>
                    <?php for ($i=0; $i < count($staff_packaging); $i++) { ?>
                        <div class="form-group row">
                            ...
                            <div class="col-md-2">
                                <label>&nbsp;</label><br>
                                <button data-code="<?php echo ($staff_packaging[$i]["STBPA_ID"]); ?>" data-action="{{ route('master_data_sub_batch_packaging_delete_staff') }}" class="btn btn-sm font-weight-bolder delete_btn btn-light-danger"><i class="la la-trash-o"></i>Delete</button>
                            </div>
                        </div>
                    <?php } ?>
                    <div class="form-group row">
