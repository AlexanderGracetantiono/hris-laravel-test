...
<div class="row">
    <div class="col-lg-12">
        <div class="card card-custom gutter-b">
            ...
            <form class="form" id="form" method="POST" action="{{ route('master_data_sub_batch_packaging_update_progress') }}" data-form-success-redirect="{{ route("master_data_sub_batch_packaging_view") }}" enctype="multipart/form-data">
                <div class="card-body">
                    @csrf
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-lg-4">
                            <label>New Batch Packaging Quantity:</label>
                    ...
                    <div class="form-group row">
                        <div class="col-md-12">
                            <br><h4>4. Assigned Staff Packaging</h4>
                        </div>
                    </div>
