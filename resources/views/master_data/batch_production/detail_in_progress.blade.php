        ...
        <div class="card card-custom gutter-b">
            ...
            <form class="form" id="form" method="POST" data-form-success-redirect="{{ route('master_data_batch_production_view') }}">
                ...
                <div class="card-body">
                    ...
                    <div class="form-group row">
                        <div class="col-lg-4">
                            <label>Packaging Admin:</label>
                            <select class="form-control select2 employee" name="MABPA_ASSIGNED_EMPLOYEE_CODE">
                                <option></option>
                                <?php for ($j = 0; $j < count($employee_admin_packaging); $j++) { ?>
                                    <option value="<?php echo $employee_admin_packaging[$j]["MAEMP_CODE"] ?>"><?php echo $employee_admin_packaging[$j]["MAEMP_TEXT"] ?></option>
                                <?php } ?>
                            </select>
                        </div>
                        <div class="col-lg-4">
                        ...
                        <div class="col-lg-4">
                            ...
                            <input disabled class="form-control" id="MABPR_TIME_END" name="MABPR_TIME_END" value="<?php echo substr($data["MABPR_CLOSED_TIMESTAMP"],11,5); ?>" type="text"/>
                        </div>
                    </div>
                    <div class="form-group row">
                        <div class="col-lg-12">
