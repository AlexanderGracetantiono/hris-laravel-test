                    ...
                    <table>
                        <tr>
                            ...
                            <td style="text-align:center;">
                                ...
                                Batch Name: <?php echo $data["MABPR_TEXT"]; ?><br>
                                Brand Name: <?php echo $data["MABPR_MBRAN_TEXT"]; ?><br>
            ...
            <tr class="top">
                <td colspan="2">
                    <table>
                        ...
                        <tr class="custom">
                            <td><center>
                                <?php echo $data["MABPR_MPRCA_TEXT"]; ?>
                                </center>
                            </td>
                            <td><center>
                                <?php echo $data["MABPR_MPRDT_TEXT"]; ?>
                                </center>
                            </td>
                            <td><center>
                                <?php echo $data["MABPR_MPRMO_TEXT"]; ?>
                            </center>
                            </td>
                            <td><center>
                                <?php echo $data["MABPR_MPRVE_TEXT"]; ?>
                            </center>
                            </td>
                            <td><center>
                                <?php echo $data["MABPR_MPRVE_SKU"]; ?>
                            </center>
                            </td>
                            <td><center>
