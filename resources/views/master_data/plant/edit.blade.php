...
@section('page_title', 'Edit Production / Packaging Center Form')
    ...
    <div class="col-lg-12">
        <div class="card card-custom gutter-b">
            <div class="card-header">
                <h3 class="card-title">Edit Production / Packaging Center Form</h3>
            </div>
            <form class="form" id="form" method="POST" action="{{ route("master_data_plant_update") }}" data-form-success-redirect="{{ route("master_data_plant_view") }}" enctype="multipart/form-data">
                @csrf
                <input type="hidden" value="<?php echo $data["MAPLA_ID"]; ?>" name="MAPLA_ID">
                <div class="card-body">
                    <div class="form-group row">
                        <div class="col-lg-4">
                            <label>Production / Packaging Center Code:</label>
                        ...
                        <div class="col-lg-4">
                            ...
                            <input type="text" maxlength="255" class="form-control" name="MAPLA_TEXT" value="<?php echo $data["MAPLA_TEXT"]; ?>" placeholder="Input production / packaging center name">
                        </div>
                        <div class="col-lg-4">
                            <label>Production / Packaging Center Type:</label>
                            <select class="form-control select2" id="plant" name="MAPLA_TYPE">
                                <option></option>
                                    <option <?php if ($data["MAPLA_TYPE"] == 1) { echo("selected"); } ?> value="1">Production Center</option>
                                    <option <?php if ($data["MAPLA_TYPE"] == 2) { echo("selected"); } ?> value="2">Packaging Center</option>
                            </select>
                        </div>
                    </div>
                    <div class="form-group row">
                        <div class="col-lg-6">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" maxlength="255" class="form-control numeric_input" value="<?php echo $data["MAPLA_PHONE_NUMBER"]; ?>" name="MAPLA_PHONE_NUMBER" placeholder="Input production / packaging center phone number">
                            </div>
                        </div>
                        <div class="col-lg-6">
