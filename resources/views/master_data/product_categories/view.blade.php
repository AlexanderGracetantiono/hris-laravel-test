...
@section('page_title', 'View Product Category')
...
<div class="card card-custom">
    <div class="card-header py-3">
        <div class="card-title">
            ...
            <h3 class="card-label">Master Data Product Category</h3>
        </div>
        <div class="card-toolbar">
            <a href="{{ route("master_data_category_add") }}" class="btn btn-primary font-weight-bolder">
        ...
        <table class="table table-bordered table-checkable" id="kt_datatable1">
            ...
            <tbody>
                ...
                <tr <?php if ($product_cat['MPRCA_STATUS'] != 1) { echo ("style='background-color:#eeeeee'");} ?> >
                    ...
                    <td nowrap="nowrap">
                        <a href="{{ route("master_data_category_edit", ["maprca_id" => $product_cat["MPRCA_ID"]]) }}" class="btn btn-sm btn-clean btn-icon"   title="Edit Category"> <i
                            class="la la-edit"></i>
                        </a>
                        <button type="button" data-code="{{ $product_cat['MPRCA_ID'] }}" data-action="{{ route('master_data_category_delete') }}"
