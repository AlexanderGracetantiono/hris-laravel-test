		...
		<div class="d-flex flex-column flex-root">
			<div class="error error-6 d-flex flex-row-fluid bgi-size-cover bgi-position-center" style="background-color: #4a1c40;">
				<div class="d-flex flex-column flex-row-fluid text-center">
					...
					<h1 class="error-title font-weight-boldest text-white mb-12" style="margin-top: 6rem;">Yay!</h1>
					<p class="display-4 font-weight-bold text-white">Your password has been successfully registered ! Now you can login to your CekOri Account</p>
				</div>
			</div>
		</div>
