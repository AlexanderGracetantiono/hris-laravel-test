...
@section('page_title', 'Add Testing Center / Laboratorium Form')
...
@push('scripts')
<script src="{{ asset('custom/js/master_data_lab/plant/add/map_ajax.js') }}"></script>
<script src="{{ asset('custom/js/master_data_lab/plant/add/select2.js') }}"></script>
<script src="{{ asset('custom/js/master_data_lab/plant/add/submit_ajax.js') }}"></script>
@endpush
    ...
    <div class="col-lg-12">
        <div class="card card-custom gutter-b">
            <div class="card-header">
                <h3 class="card-title">Add Testing Center / Laboratorium Form</h3>
            </div>
            <form class="form" id="form" method="POST" action="{{ route('master_data_lab_plant_save') }}" data-form-success-redirect="{{ route('master_data_lab_plant_view') }}" enctype="multipart/form-data">
                @csrf
                <div class="card-body">
                    <div class="form-group row">
                        <div class="col-lg-6">
                            <label>Testing Center / Laboratorium Name:</label>
                            <input type="text" maxlength="255" class="form-control" name="MAPLA_TEXT" placeholder="Input Testing Center / Laboratorium name">
                        </div>
                        <div class="col-lg-6">
                            <label>Testing Center / Laboratorium Type:</label>
                            <select class="form-control select2" id="plant" name="MAPLA_TYPE">
                                <option></option>
                                    <option value="1">Testing Center</option>
                                    <option value="2">Laboratorium Center</option>
                            </select>
                        </div>
                    </div>
                    <div class="form-group row">
