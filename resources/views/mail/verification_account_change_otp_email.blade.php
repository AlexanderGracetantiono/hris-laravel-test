...
<head>
	...
	<title>CekOri Account Change Verification Email</title>
	<style type="text/css">
		/* RESET STYLES */
		html {
																		...
																		<tr>
																			<td align="left" class="textContent">
																				<div style="font-family:'Avenir Next', Helvetica, Arial, sans-serif;;font-size:13px;color:#828282;text-align:center;line-height:120%;">
																					CekOri Account Change Verification Email
																				</div>
																			</td>
																		</tr>
																	</table>
														...
														<table border="0" cellpadding="30" cellspacing="0" width="100%">
															<tr>
																<td align="center" valign="top" class="textContent">
																	...
																	<h2 style="text-align:center;font-weight:normal;font-family:'Avenir Next', Helvetica, Arial, sans-serif;;font-size:23px;margin-bottom:10px;color:#FFFFFF;line-height:135%;">Your User Account's Request Info</h2>
																</td>
															</tr>
														</table>
														<!-- // CONTENT TABLE -->
																	...
																	<table border="0" cellpadding="0" cellspacing="0" width="100%">
																		<tr>
																			<td valign="top" class="textContent">
																				...
																				@endif
																				<h3 mc:edit="header" style="color:#91191b;line-height:200%;font-family:'Avenir Next', Helvetica, Arial, sans-serif;;font-size:20px;font-weight:normal;margin-top:0;margin-bottom:3px;text-align:left;">Dear <span style="font-weight: bold;">{{ $data['name'] }}</span>,</h3>
																				<div mc:edit="body" style="text-align:left;font-family:'Avenir Next', Helvetica, Arial, sans-serif;;font-size:15px;margin-bottom:5px;color:#5F5F5F;line-height:150%;">We have been requested a account change verification for this email.</div>
																				...
																				<div mc:edit="body" style="text-align:center;font-family:'Avenir Next', Helvetica, Arial, sans-serif;;font-size:15px;margin-bottom:5px;color:#5F5F5F;line-height:150%;">
																					<table>
																						<tr>
																							<td style="text-align:left;font-family:'Avenir Next', Helvetica, Arial, sans-serif;;font-size:15px;margin-bottom:5px;color:#5F5F5F;line-height:150%;vertical-align: top;"><span style="margin-right:5px;">User Name</span></td>
																							...
																							<td style="text-align:left;font-family:'Avenir Next', Helvetica, Arial, sans-serif;;font-size:15px;margin-bottom:5px;color:#5F5F5F;line-height:150%;"><span style="margin-left:5px;font-weight: bold;">{{ $data['name'] }}</span></td>
																						</tr>
																						@if($data['brand_logo'] != null)
																						<tr>
																							...
																							<td style="text-align:center;font-family:'Avenir Next', Helvetica, Arial, sans-serif;;font-size:15px;margin-bottom:5px;color:#5F5F5F;line-height:150%;vertical-align: top;">:</td>
																							<td style="text-align:left;font-family:'Avenir Next', Helvetica, Arial, sans-serif;;font-size:15px;margin-bottom:5px;color:#5F5F5F;line-height:150%;"><span style="margin-left:5px;font-weight: bold;">{{ $data['username'] }}</span></td>
																						</tr>
																						@endif
																						<tr>
																							<td style="text-align:left;font-family:'Avenir Next', Helvetica, Arial, sans-serif;;font-size:15px;margin-bottom:5px;color:#5F5F5F;line-height:150%;vertical-align: top;"><span style="margin-right:5px;">Verification Code</span></td>
																							<td style="text-align:center;font-family:'Avenir Next', Helvetica, Arial, sans-serif;;font-size:15px;margin-bottom:5px;color:#5F5F5F;line-height:150%;vertical-align: top;">:</td>
																							<td style="text-align:left;font-family:'Avenir Next', Helvetica, Arial, sans-serif;;font-size:15px;margin-bottom:5px;color:#5F5F5F;line-height:150%;"><span style="margin-left:5px;font-weight: bold;">{{ $data['otp_code'] }}</span></td>
																						</tr>
																					</table>
																				</div>
																				<br/>

																				<div mc:edit="body" style="text-align:left;font-family:'Avenir Next', Helvetica, Arial, sans-serif;;font-size:15px;margin-bottom:5px;color:#5F5F5F;line-height:150%;">If you did not perform a account change verification request, please contact our support team at
