...
<head>
	...
	<title>CekOri Change Brand Name</title>
	<style type="text/css">
		/* RESET STYLES */
		html {
														...
														<table border="0" cellpadding="30" cellspacing="0" width="100%">
															<tr>
																<td align="center" valign="top" class="textContent">
																	...
																	<h2 style="text-align:center;font-weight:normal;font-family:'Avenir Next', Helvetica, Arial, sans-serif;;font-size:23px;margin-bottom:10px;color:#FFFFFF;line-height:135%;">Confirm Change Brand Name</h2>
																</td>
															</tr>
														</table>
														<!-- // CONTENT TABLE -->
																	...
																	<table border="0" cellpadding="0" cellspacing="0" width="100%">
																		<tr>
																			<td valign="top" class="textContent">
																				...
																				<div mc:edit="body" style="text-align:left;font-family:'Avenir Next', Helvetica, Arial, sans-serif;;font-size:15px;margin-bottom:5px;color:#5F5F5F;line-height:150%;">There has been a change brand name.</div>
																				...
																				<div mc:edit="body" style="text-align:center;font-family:'Avenir Next', Helvetica, Arial, sans-serif;;font-size:15px;margin-bottom:5px;color:#5F5F5F;line-height:150%;">
																					<table>
																						<tr>
																							<td style="text-align:left;font-family:'Avenir Next', Helvetica, Arial, sans-serif;;font-size:15px;margin-bottom:5px;color:#5F5F5F;line-height:150%;vertical-align: top;"><span style="margin-right:5px;">Company Name</span></td>
																							...
																							<td style="text-align:left;font-family:'Avenir Next', Helvetica, Arial, sans-serif;;font-size:15px;margin-bottom:5px;color:#5F5F5F;line-height:150%;"><span style="margin-left:5px;font-weight: bold;">{{ $data['company_name'] }}</span></td>
																						</tr>
																						<tr>
																							<td style="text-align:left;font-family:'Avenir Next', Helvetica, Arial, sans-serif;;font-size:15px;margin-bottom:5px;color:#5F5F5F;line-height:150%;vertical-align: top;"><span style="margin-right:5px;">Brand Name Before</span></td>
																							<td style="text-align:center;font-family:'Avenir Next', Helvetica, Arial, sans-serif;;font-size:15px;margin-bottom:5px;color:#5F5F5F;line-height:150%;vertical-align: top;">:</td>
																							<td style="text-align:left;font-family:'Avenir Next', Helvetica, Arial, sans-serif;;font-size:15px;margin-bottom:5px;color:#5F5F5F;line-height:150%;"><span style="margin-left:5px;font-weight: bold;">{{ $data['brand_name_original'] }}</span></td>
																						</tr>
																						<tr>
																							<td style="text-align:left;font-family:'Avenir Next', Helvetica, Arial, sans-serif;;font-size:15px;margin-bottom:5px;color:#5F5F5F;line-height:150%;vertical-align: top;"><span style="margin-right:5px;">New Brand Name</span></td>
																							<td style="text-align:center;font-family:'Avenir Next', Helvetica, Arial, sans-serif;;font-size:15px;margin-bottom:5px;color:#5F5F5F;line-height:150%;vertical-align: top;">:</td>
																							<td style="text-align:left;font-family:'Avenir Next', Helvetica, Arial, sans-serif;;font-size:15px;margin-bottom:5px;color:#5F5F5F;line-height:150%;"><span style="margin-left:5px;font-weight: bold;">{{ $data['brand_name_changed'] }}</span></td>
																						</tr>
																					</table>
																				</div>
