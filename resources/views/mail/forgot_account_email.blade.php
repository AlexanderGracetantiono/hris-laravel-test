...
<head>
	...
	<title>CekOri Forgot Account Name Email</title>
	<style type="text/css">
		/* RESET STYLES */
		html {
																		...
																		<tr>
																			<td align="left" class="textContent">
																				<div style="font-family:'Avenir Next', Helvetica, Arial, sans-serif;;font-size:13px;color:#828282;text-align:center;line-height:120%;">
																					CekOri Forgot Account Name Email
																				</div>
																			</td>
																		</tr>
																	</table>
																	...
																	<table border="0" cellpadding="0" cellspacing="0" width="100%">
																		<tr>
																			<td valign="top" class="textContent">
																				...
																				<div mc:edit="body" style="text-align:left;font-family:'Avenir Next', Helvetica, Arial, sans-serif;;font-size:15px;margin-bottom:5px;color:#5F5F5F;line-height:150%;">We have been requested a forgot account name for this email.</div>
																				...
																				<div mc:edit="body" style="text-align:left;font-family:'Avenir Next', Helvetica, Arial, sans-serif;;font-size:15px;margin-bottom:5px;color:#5F5F5F;line-height:150%;">If you did not perform a forgot account name request, please contact our support team at
