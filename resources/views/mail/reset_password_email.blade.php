...
<head>
	...
	<title>CekOri Create or Reset Password Email</title>
	<style type="text/css">
		/* RESET STYLES */
		html {
																		...
																		<tr>
																			<td align="left" class="textContent">
																				<div style="font-family:'Avenir Next', Helvetica, Arial, sans-serif;;font-size:13px;color:#828282;text-align:center;line-height:120%;">
																					CekOri Reset Create or Reset Password Email
																				</div>
																			</td>
																		</tr>
																	</table>
														...
														<table border="0" cellpadding="30" cellspacing="0" width="100%">
															<tr>
																<td align="center" valign="top" class="textContent">
																	...
																	<h2 style="text-align:center;font-weight:normal;font-family:'Avenir Next', Helvetica, Arial, sans-serif;;font-size:23px;margin-bottom:10px;color:#FFFFFF;line-height:135%;">Please Create or Reset Your Password</h2>
																</td>
															</tr>
														</table>
														<!-- // CONTENT TABLE -->
																	...
																	<table border="0" cellpadding="0" cellspacing="0" width="100%">
																		<tr>
																			<td valign="top" class="textContent">
																				...
																				<div mc:edit="body" style="text-align:left;font-family:'Avenir Next', Helvetica, Arial, sans-serif;;font-size:15px;margin-bottom:5px;color:#5F5F5F;line-height:150%;">There has been a Create or Reset password request for this user account.</div>
																				...
																				<div mc:edit="body" style="text-align:center;font-family:'Avenir Next', Helvetica, Arial, sans-serif;;font-size:15px;margin-bottom:5px;color:#5F5F5F;line-height:150%;">
																					<table>
																						<tr>
																							<td style="text-align:left;font-family:'Avenir Next', Helvetica, Arial, sans-serif;;font-size:15px;margin-bottom:5px;color:#5F5F5F;line-height:150%;vertical-align: top;"><span style="margin-right:5px;">User Account</span></td>
																					...
																					<table>
																						<tr>
																							<td style="text-align:center;font-family:'Avenir Next', Helvetica, Arial, sans-serif;;font-size:15px;margin-top:5px;margin-bottom:5px;color:#5F5F5F;line-height:200%;">
																								<a href="{{ $data['link'] }}">Create or Reset Password</a>
																							</td>
																						</tr>
																					</table>
																				</div>
																				...
																				<div mc:edit="body" style="text-align:left;font-family:'Avenir Next', Helvetica, Arial, sans-serif;;font-size:12px;margin-bottom:5px;color:#5F5F5F;line-height:150%;margin-top:20px;">If clicking on the create or reset password above didn't work, please copy-paste the following link to your internet browser : </div>
