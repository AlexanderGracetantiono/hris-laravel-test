														...
														<table border="0" cellpadding="30" cellspacing="0" width="100%">
															<tr>
																<td align="center" valign="top" class="textContent">
																	...
																	<h2 style="text-align:center;font-weight:normal;font-family:'Avenir Next', Helvetica, Arial, sans-serif;;font-size:23px;margin-bottom:10px;color:#FFFFFF;line-height:135%;">Please Scan your <span style="font-weight: bold;">{{ $data_brand }}</span> Lab Test Result from within CekOri Apps!</h2>
																</td>
															</tr>
														</table>
														<!-- // CONTENT TABLE -->
																	...
																	<table border="0" cellpadding="0" cellspacing="0" width="100%">
																		<tr>
																			<td valign="top" class="textContent">
																					...
																					<table border="0" width="100%">
																						<tr>
																							<td valign="top" style="text-align:center;" class="textContent">
																								<img src="{{ asset('storage/images/brand_logo') }}/{{ $brand_logo }}" alt="Brand Logo" title="Brand Logo" style="width:60px;height:60px">
																							</td>
																						</tr>
																					</table>
																					<br />
																				...
																				<div mc:edit="body" style="text-align:left;font-family:'Avenir Next', Helvetica, Arial, sans-serif;;font-size:15px;margin-bottom:5px;color:#5F5F5F;line-height:150%;">This test result is sent for you as a result of your visit to <span style="font-weight: bold;">{{ $data_brand }}</span> on <span style="font-weight: bold;">{{ $test_date }}</span> for a laboratory test.</div>
																				...
																				<div mc:edit="body" style="text-align:left;font-family:'Avenir Next', Helvetica, Arial, sans-serif;;font-size:15px;margin-bottom:5px;color:#5F5F5F;line-height:150%;">If you don't have the apps installed you can download CekOri apps at :</div>
																				<br />
																				...
																				<div mc:edit="body" style="text-align:left;font-family:'Avenir Next', Helvetica, Arial, sans-serif;;font-size:15px;margin-bottom:5px;color:#5F5F5F;line-height:150%;">Then log in with the above mobile number as you have already registered in our system.</div>
																				<br />
																				...
																				<div mc:edit="body" style="text-align:left;font-family:'Avenir Next', Helvetica, Arial, sans-serif;;font-size:15px;margin-bottom:5px;color:#5F5F5F;line-height:150%;">If you did not perform an laboratorium test request, please contact our support team at
