...
<head>
	...
	<title>CekOri Account Information Changes Notification Email</title>
	<style type="text/css">
		/* RESET STYLES */
		html {
																		...
																		<tr>
																			<td align="left" class="textContent">
																				<div style="font-family:'Avenir Next', Helvetica, Arial, sans-serif;;font-size:13px;color:#828282;text-align:center;line-height:120%;">
																					CekOri Account Information Changes Notification Email
																				</div>
																			</td>
																		</tr>
																	</table>
														...
														<table border="0" cellpadding="30" cellspacing="0" width="100%">
															<tr>
																<td align="center" valign="top" class="textContent">
																	...
																	<h2 style="text-align:center;font-weight:normal;font-family:'Avenir Next', Helvetica, Arial, sans-serif;;font-size:23px;margin-bottom:10px;color:#FFFFFF;line-height:135%;">Your Account Information has been Changed</h2>
																</td>
															</tr>
														</table>
														<!-- // CONTENT TABLE -->
																		...
																		<tr>
																			<td valign="top" class="textContent">
																				<!--
																					...
																					-->
																				<h3 mc:edit="header" style="color:#91191b;line-height:200%;font-family:'Avenir Next', Helvetica, Arial, sans-serif;;font-size:20px;font-weight:normal;margin-top:0;margin-bottom:3px;text-align:left;">Dear <span style="font-weight: bold;">{{ $name }}</span>,</h3>
																				<div mc:edit="body" style="text-align:left;font-family:'Avenir Next', Helvetica, Arial, sans-serif;;font-size:15px;margin-bottom:5px;color:#5F5F5F;line-height:150%;">There has been a changes on your account information.</div>

																				<br/>
																				<div mc:edit="body" style="text-align:left;font-family:'Avenir Next', Helvetica, Arial, sans-serif;;font-size:15px;margin-bottom:5px;color:#5F5F5F;line-height:150%;">If you did not request the changes, please contact our support team at
