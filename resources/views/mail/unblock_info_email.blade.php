...
<head>
	...
	<title>CekOri Unblock Account Notification Email</title>
	<style type="text/css">
		/* RESET STYLES */
		html {
																		...
																		<tr>
																			<td align="left" class="textContent">
																				<div style="font-family:'Avenir Next', Helvetica, Arial, sans-serif;;font-size:13px;color:#828282;text-align:center;line-height:120%;">
																					CekOri Unblock Account Notification Email
																				</div>
																			</td>
																		</tr>
																	</table>
														...
														<table border="0" cellpadding="30" cellspacing="0" width="100%">
															<tr>
																<td align="center" valign="top" class="textContent">
																	...
																	<h2 style="text-align:center;font-weight:normal;font-family:'Avenir Next', Helvetica, Arial, sans-serif;;font-size:23px;margin-bottom:10px;color:#FFFFFF;line-height:135%;">Your Account Has Been Unblocked</h2>
																</td>
															</tr>
														</table>
														<!-- // CONTENT TABLE -->
																	...
																	<table border="0" cellpadding="0" cellspacing="0" width="100%">
																		<tr>
																			<td valign="top" class="textContent">
																				...
																				<div mc:edit="body" style="text-align:left;font-family:'Avenir Next', Helvetica, Arial, sans-serif;;font-size:15px;margin-bottom:5px;color:#5F5F5F;line-height:150%;">We have unblocked your account, you can try login again</div>
																				...
																				<div mc:edit="body" style="text-align:left;font-family:'Avenir Next', Helvetica, Arial, sans-serif;;font-size:15px;margin-bottom:5px;color:#5F5F5F;line-height:150%;">If you did not perform an unblock account request, please contact our support team at
