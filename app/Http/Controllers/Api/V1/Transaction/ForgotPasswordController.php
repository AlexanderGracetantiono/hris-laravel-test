...
class ForgotPasswordController extends Controller
{
    ...
    public function forgot_password_view(Request $request)
    {
        ...
        $user_data = std_get([
            "select" => ["MAEMP_EMAIL", "MAEMP_TEXT", "MAEMP_CODE", "MAEMP_BLOCKED_STATUS", "MAEMP_IS_DELETED"],
            "table_name" => "MAEMP",
            "where" => [
                [
    ...
    public function forgot_password_save(Request $request)
    {
        ...
        $user_data = std_get([
            "select" => ["MAEMP_EMAIL", "MAEMP_TEXT", "MAEMP_USER_NAME", "MAEMP_BLOCKED_STATUS", "MAEMP_IS_DELETED"],
            "table_name" => "MAEMP",
            "where" => [
                [
                    "field_name" => "MAEMP_CODE",
        ...
        if ($update_res === false) {
            return response()->json([
                'message' => "Terjadi kesalahan dalam melakukan proses reset password, silahkan coba berberapa saat lagi"
            ], 500);
        }
