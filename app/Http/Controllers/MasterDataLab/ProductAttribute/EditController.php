    ...
    public function index(Request $request)
    {
        ...
        if ($check_access == false) {
            if ($check_product_attribute["MBRAN_TRPAT_TYPE"] == 1) {
                return redirect('/test_lab/master_data/product/product_categories/view');
            } elseif ($check_product_attribute["MBRAN_TRPAT_TYPE"] == 2) {
                return redirect('/test_lab/master_data/product/product/view');
            } elseif ($check_product_attribute["MBRAN_TRPAT_TYPE"] == 3) {
                return redirect('/test_lab/master_data/product/product_model/view');
            } elseif ($check_product_attribute["MBRAN_TRPAT_TYPE"] == 4) {
                return redirect('/test_lab/master_data/product/product_version/view');
            }
        }
        ...
        return view('master_data_lab/product_attribute/view',[
