...
namespace App\Http\Controllers\MasterData\SubBatchDelivery;
...
class ViewController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('master_data/batch_delivery/view', ['data' => $data]);
    }
    ...
    public function scanned_qr(Request $request)
    {
        ...
        return view('master_data/batch_delivery/scanned_qr', [
    ...
    public function scanned_qr_closed(Request $request)
    {
        ...
        return view('master_data/batch_delivery/scanned_qr_closed', [
            'data_sub_batch' => $data_sub_batch,
            'pool_product' => $pool_product,
            'data_qr' => $data_qr,
            'link_qr' => $link_qr,
    ...
    public function delivery_note(Request $request)
    {
        ...
        $pdf = PDF::loadView('master_data/batch_delivery/delivery_note', [
            "data" => $data,
            "count_paired_qr" => $count_paired_qr,
