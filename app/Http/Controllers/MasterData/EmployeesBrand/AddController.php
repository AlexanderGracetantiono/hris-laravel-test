...
class AddController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('master_data/brand_employees/add', [
            "brand" => $brand,
            "code" => $code,
        ]);
    }
    ...
    public function save(Request $request)
    {
        ...
        $company = get_master_brand("*",[
            [
                "field_name" => "MBRAN_CODE",
                "operator" => "=",
                "value" => $request->MAEMP_MBRAN_CODE,
            ]
        ],true);

        $code = generate_code($company["MBRAN_MCOMP_CODE"],5,"MAEMP");
        ...
        $insert_data = [
            ...
            "MAEMP_MCOMP_CODE" => $company["MBRAN_MCOMP_CODE"],
            "MAEMP_MCOMP_NAME" => $company["MBRAN_MCOMP_NAME"],
            "MAEMP_MBRAN_CODE" => $company["MBRAN_CODE"],
            "MAEMP_MBRAN_NAME" => $company["MBRAN_NAME"],
        ...
        try {
            ...
            $insert_lgema_data = [
                ...
                "LGEMA_COMP_CODE" => $company["MBRAN_MCOMP_CODE"],
                "LGEMA_COMP_NAME" => $company["MBRAN_MCOMP_NAME"],
                "LGEMA_BRAN_CODE" => $company["MBRAN_CODE"],
                "LGEMA_BRAN_NAME" => $company["MBRAN_NAME"],
