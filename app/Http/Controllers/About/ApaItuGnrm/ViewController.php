...
class ViewController extends Controller
{
    public function index()
    {
        ...
        $gnrm_data['apa_itu_gnrm_meta_keywords'] = json_decode($gnrm_data['apa_itu_gnrm_meta_keywords'],true);
        if (is_array($gnrm_data['apa_itu_gnrm_meta_keywords'])) {
            $gnrm_data['apa_itu_gnrm_meta_keywords'] = implode(', ',$gnrm_data['apa_itu_gnrm_meta_keywords']);
        }
        return view('about/apa_itu_gnrm/view', ['gnrm_data' => $gnrm_data]);
    }
