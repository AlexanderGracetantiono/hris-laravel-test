function get_staff_production_function(date,start_time,end_time) {
...
$(document).ready(function () {
    $("#err_message").hide();
    $("#MABPR_DATE_START").on("change", function () {
        var date = $(this).val();
    ...
    $("#MABPR_TIME_START").on("change", function () {
    ...
    $("#MABPR_TIME_END").on("change", function () {
        var date = $("#MABPR_DATE_START").val();
        var start_time = $("#MABPR_TIME_START").val();
