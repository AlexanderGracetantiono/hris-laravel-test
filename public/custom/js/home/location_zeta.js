$(document).ready(function () {
    ...
    var company = $("#company_select2").val();
    ...
    // if (category && product && model && version) {
        $.ajax({
            type: "GET",
            url: "../dashboard_admin/location_zeta",
            data: {company:company,brand:brand,category:category,product:product,model:model,version:version},
            dataType: "JSON",
